...
// parsed. It can be inspected for the specific tag name, the contents, and
// the intended type.
...
// ErrInvalidValue indicates that the expected value did not match the
// received value.
...
// VerifyAssertionConditions inspects an assertion element and makes sure
// that all SAML2 contracts are upheld.
...
// Validate ensures that the assertion passed is valid for the current
// Service Provider.
